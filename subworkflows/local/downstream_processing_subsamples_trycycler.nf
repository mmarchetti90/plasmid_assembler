...
include { MedakaPolishTrycycler } from '../../modules/local/medaka/medaka_polish_trycycler.nf'
...
workflow DOWNSTREAM_PROCESSING_SUBSAMPLES_TRYCYCLER {
  ...
  // Polish assembly
  MedakaPolishTrycycler(trycycler_consensus_data)

  polished_assembly = MedakaPolishTrycycler.out.polished_assembly
  draft_alignment = MedakaPolishTrycycler.out.draft_alignment
  ...
  // ab1 generation
  PileupToAb1(alignment_script, "trycycler_consensus_assembly", alignment_pileup)
  ...
  reference_fasta
    .combine(polished_assembly, by: 0)
